# Azure Function App - eventTrigger

This folder contains the **eventTrigger** Azure Function App project.
...
- Add a repository secret with the publish profile from Azure Portal, named `EVENTTRIGGER_PUBLISH_PROFILE`.  
