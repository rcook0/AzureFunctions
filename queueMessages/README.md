# Azure Function App - queueMessages

This folder contains the **queueMessages** Azure Function App project.
...
- Add a repository secret with the publish profile from Azure Portal, named `QUEUEMESSAGES_PUBLISH_PROFILE`.  
