# Azure Function App - durableFuncions

This folder contains the **durableFuncions** Azure Function App project.
...
- Add a repository secret with the publish profile from Azure Portal, named `DURABLEFUNCIONS_PUBLISH_PROFILE`.  
